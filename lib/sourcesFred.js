...
export default class SourcesFred extends FRED_API {
    ...
    async fetchSourceReleases(source_id) {
        try {
            if(typeof source_id === 'undefined') {
                throw Error(`Warning, series not set.`)
            };
            
            this.#fullURL = super.constructURL(source_id, 'source/releases?source_id=', this.baseURL, this.optionsURL).concat(this.#apiKey);
